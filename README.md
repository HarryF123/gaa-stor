...
Will hopefully implement Java API background, for user creation, also statistics uploading. These club and player statistics and records are to be held in a PostgreSQL database.